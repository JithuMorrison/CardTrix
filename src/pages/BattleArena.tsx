  ...
  return (
    <div className={`arena-container ${shaking ? 'screen-shake' : ''}`} style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="arena-field" style={{ position: 'relative', zIndex: 5, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', flex: 1, gap: '15%' }}>
        ...
        {/* Player Half (Left) */}
        <div className="arena-half player-half" style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', marginRight: -560 }}>
        ...
        {/* Enemy Half (Right) */}
        <div className="arena-half enemy-half" style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', marginLeft: -60 }}>
        ...
        <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap', justifyContent: 'center', marginTop: 8 }}>
          {creature.buffs.slice(0, 4).map((buff, i) => (
            <div key={i} title={`${buff.type}: ${buff.value} (${buff.remainingTurns} turns)`}
              style={{
                width: 20, height: 20, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.65rem', border: '1px solid rgba(0,0,0,0.3)',
